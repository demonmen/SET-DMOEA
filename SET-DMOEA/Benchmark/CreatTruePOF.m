...
%                             hold on;
                        ...
                        %     X = X';
                            ...
                            for i = 1:cnt
                                for j = 2:N
                                    PS(i,j) = sin(6*pi*PS(i,1)+j*pi/N)+G; 
                                end
                            end
                            PF = zeros(cnt,2);      
                            for i = 1:cnt
...
%                              hold on
                        ...
                        %     X = X';
                            ...
                            for i = 1:cnt
                                for j = 2:N
                                    PS(i,j) = PS(i,1)^(0.5*(2+3*(j-2)/(N-2)+G))+G; 
                                end
                            end
                            PF = zeros(cnt,2);      
                            for i = 1:cnt
...
%                              hold on
                        ...
                        %     X = X';
                            ...
                            for i = 1:cnt
                                for j = 2:N
                                    PS(i,j) = sin(6*pi*PS(i,1)+(j+K)*pi/N); 
                                end
                            end
                            PF = zeros(cnt,2);      
                            for i = 1:cnt
...
%                              hold on
                        ...
                        case 'UDF7'
                            ...
                            for i = 1:size(PS,1)
                                for j = 3:N
                                    PS(i,j) = 2*PS(i,2)*sin(2*pi*PS(i,1)+j*pi/N) ;%b+1-(abs(PS(i,1)-a)).^(H+j/N);
                                end
                            end
                            for i = 1:size(PS,1)
                                [PF(i,:),~] = UDF7(PS(i,:),t);
